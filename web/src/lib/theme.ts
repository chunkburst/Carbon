...
// WebView2 can briefly expose a storage area that is unavailable, for example while its profile
// is locked by another process. Theme setup runs before React mounts, so keep the preference
